"""Search input widget for Ganger.

Provides an overlay input field for searching starred repositories.

Modified: 2025-11-08
Adapted from yanger/ui/search_input.py
"""
...
class SearchInput(Container):
    ...
    def show(self, placeholder: str = "Search repos...") -> None:
